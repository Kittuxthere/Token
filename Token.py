...
<head>
    ...
    <title>Facebook Token Generator | by Kittu</title>
...
<body>
    ...
    <footer>
        <p>Developed with ❤️ by kittu <a href="https://github.com/Kittuxthere" target="_blank">
            <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
def get_facebook_token(cookies):
    ...
    """
    url = "https://kittu.online/api/facebook_token"
